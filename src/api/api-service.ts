...
export class ApiService {
    ...
    public static getReservation(reservationId: string): Observable<any> {
        return from( axios.get(this.SERVICE_URL + `reservations/${reservationId}`) );
    }
    ...
    public static putReservation(data: any): Observable<any> {
        return from( axios.put(this.SERVICE_URL + `reservations/${data.id}`, data) );
    }

    public static deleteReservation(reservationId: string): Observable<any> {
        return from( axios.delete(this.SERVICE_URL + `reservations/${reservationId}`) );
    }
}